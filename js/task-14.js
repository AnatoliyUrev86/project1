...
// export default - дефолтний експорт в нашому файлі може бути лише один
// import - також інмпортувати можемо лише одну сутність за дефолтом

// Як раз для того щоб ми могли  експортувати з нашого файлу не лише одну сутність а декілька для цього
// існує Іменований Експорт - пишумо export перед тим що ми хочемо імпортувати
export function fooEl() {
    return "lalala";
}
export const value = 5;
// Для  Іменованого Експорту пишемо слово Інпорт фігурні дужки і в них передаємо назви які хочемо імпортувати
// import { fooEl, value } from "./task-14";
// console.log("fooEl", fooEl);
// console.log("value", value);

// Якщо сталося таке що нам потрібно наприклад шмпортувати ще одне  value = 100 ми отримаємо помилку тому що в нас
// вже є value = 5 як ми це можемо вирішити
// import { fooEl, value as helperValue } from "./task-14";
// Ми після value пишемо as та нову назву helperValue в яку буде імпортуватися число тепер
// у value = 100 а в  helperValue = 5

// ІНПОРТ ПРОСТОРУ ІМЕН

// ВНІ ДАЄ МОЖЛИВІСТЬ ВСІ НАШІ ІМЕНОВАНІ ЕКСПОРТИ ЗБЕРЕГТИ В ОДНОМУ МІСЦІ
// import * as helper from "./task-14";
// * - зірочка означає що ми імпортуємо всі файли
// helper - даємо назму і вказуємо шлях з відки тобто from "./task-14" щоб отримати доступ пишемо
// console.log(helper);
